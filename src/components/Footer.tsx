      ...
      <div className="flex items-end justify-center">
        {footerLinks.map((item, index) => (
          <Link
            ...
            className={
              iconClicked === index
                ? "mx-[1vw] flex items-center justify-center text-[6vw] text-hearts-blue opacity-50 hover:scale-75 hover:text-white hover:duration-300"
                : "mx-[1vw] flex items-center justify-center text-[6vw] text-hearts-blue hover:scale-75 hover:text-white hover:duration-300"
            }
