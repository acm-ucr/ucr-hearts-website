          ...
          <div className="absolute left-[5%] top-[28%] w-[90%]">
            {dayEvents.map((event, index) => (
              <div
                ...
                className="mb-[3%] cursor-pointer rounded-lg border border-hearts-blue bg-hearts-light-blue text-[0.9vw] text-hearts-blue"
              >
    ...
    <div>
      ...
      {popupEvent && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          <div className="relative aspect-[8/3] w-[30vw] bg-hearts-blue p-[1%] font-hearts text-white shadow-lg">
